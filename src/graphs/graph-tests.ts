...
testlib.test("Triple", function(assert) {
  const triple = new Graphs.Triple("s", "p", "o");
  ...
  const triple2 = new Graphs.Triple("s2", "p2", "o2");
  const triple3 = new Graphs.Triple("s", "p", "o");
...
const setupTestGraph = function () {
  const g = new Graphs.Graph();
  const triple = new Graphs.Triple("s", "p", "o");
  const triple2 = new Graphs.Triple("s", "p", "o2");
  const triple3 = new Graphs.Triple("s", "p3", "o3");
  const triple4 = new Graphs.Triple("s4", "p4", "o4");
  g.addTriple(triple);
  g.addTriple(triple2);
  g.addTriple(triple3);
  g.addTriple(triple4);
...
testlib.test("Graph", function(assert) {
  ...
  g.removeTriple(new Graphs.Triple("s4", "p4", "o4"));
...
testlib.test("GraphNode", function(assert) {   
  const g = setupTestGraph();
  const gn = new Graphs.GraphNode(new Graphs.Triple("sx", "px", "ox"), "o");
